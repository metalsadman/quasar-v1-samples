  ...
  <q-page padding>
    <div class="q-pa-md q-gutter-md row justify-center">
      <div class="col-12 row justify-center q-gutter-md">
        <q-btn color="primary" @click="showTextLoading" :loading="visible"
          >Show Skeleton Loader</q-btn
        >
        <q-field filled label="Primary" stack-label dense>
          <template v-slot:control>
            <div
              class="self-center full-width no-outline content-stretch"
              tabindex="0"
            >
              {{ skeletonColor.primary || 'Hex color' }}
            </div>
          </template>
        ...
        <q-field filled label="Secondary" stack-label dense>
          <template v-slot:control>
            <div class="self-center full-width no-outline" tabindex="0">
              {{ skeletonColor.secondary || 'Hex color' }}
            </div>
          </template>
          <template v-slot:append>
            <q-btn
      ...
      <div class="col-12 row justify-center">
        <q-card class="bg-grey-3 relative-position card-example">
          <q-card-section>
            <div class="text-h6" v-if="showSimulatedReturnData">
              Lorem Ipsum
            </div>
          </q-card-section>
