    ...
    @mousedown.native.prevent
      ...
      <template v-slot:top="props">
        <div class="row col-12">
          <div v-if="$attrs.title" class="col-12 text-center text-h5 q-pb-md">
            {{ $attrs.title }}
          </div>
          <div v-if="$attrs.subTitle" class="col-12 text-center text-caption">
            {{ $attrs.subTitle }}
          </div>
        </div>
        <div
        ...
        >
          ...
          >
            <template v-slot:append>
              <q-icon name="mdi-magnify" :color="theme" />
            </template>
          </q-input>
          <div
            :class="
          ...
          >
            ...
            <template v-if="gridCardStyle === 'horizontal'">
              <q-card-section class="relative-position">
                ...
                />
                <div v-if="!toggleSelectionMode" class="ellipsis-2-lines">
                  {{ props.cols[0].value }}
                </div>
              </q-card-section>
              <q-separator />
